const HELP_COPY = Object.freeze({
  zh: Object.freeze({
    ...
    faqMediaQ: '可以下载当前视频和音频吗？', faqMediaA: '可以。在弹窗的“视频下载”区域选择清晰度与模式，即可把视频+音频、仅音频或仅视频保存到本机。', faqThreeQ: 'TXT 和 SRT 有什么区别？', faqThreeA: 'TXT 只保留字幕文字，适合阅读和二次编辑；SRT 保留时间轴，适合导入视频播放器或剪辑软件。',
  ...
  en: Object.freeze({
    ...
    faqMediaQ: 'Can I download the current video and audio?', faqMediaA: 'Yes. Use the Media download section in the popup to save video + audio, audio only, or video only.', faqThreeQ: 'What is the difference between TXT and SRT?', faqThreeA: 'TXT keeps only the words for reading or editing. SRT keeps timestamps for video players and editing tools.',
